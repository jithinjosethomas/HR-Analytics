...
#KS Test measures to check whether model is able to separate events and non-events. 
#In probability of attrition(employee attrition) model, it checks whether the attrition 
#model is able to distinguish between employees going to stay and leave the organization.
#Accuracy   72.56%
#Sensitivity 71.83%
#Specificity 72.70%
#In our case, KS score is 44.45
...
graphics::plot(Attrition_decile$bucket, Attrition_decile$Gain, type="l", ylab="Cumulative Gain %", xlab="Bucket")